...
{
	/* listType (structureList.xsd)
	 * 
	 * Attributes: (contentIdentificationSharingAndConditionGroup - base.xsd)
	 *	- address (ID : NCName)
	 *	
	 * Attributes:
	 *	- class (DaveSexton.XmlGel.Maml.ListKind)
	 * 
	 * Content: (1..N)
	 *	- Allows 0..N listItem (MamlListItem) elements
	 *	- Allows 0..N conditionalSection elements
	 *		- Sequence:
	 *			- conditions (MamlConditions) element
	 *			- conditionalContent (MamlList) element
	 */
	internal sealed class MamlList : MamlNode
	{
		public MamlList(XElement element)
			: base(element)
		{
		}
