...
{
	/* inlineLinkType (inlineLinking.xsd)
	 * 
	 *	- Extends: textType (XSD)
	 * 
	 ...
	 *
	 * Content: 
	 *	- Allows text (mixed content), though apparently it's ignored according to the doc
	 */
	internal sealed class MamlLink : MamlText
	{
		public Uri Href
		{
			get
		...
		public MamlLink(XElement element)
			: base(element)
		{
		}
