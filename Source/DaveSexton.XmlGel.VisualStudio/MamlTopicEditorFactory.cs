...
namespace DaveSexton.XmlGel.VisualStudio
{
	...
	/// </summary>
	[Guid(GuidList.guidDaveSexton_XmlGel_VisualStudioEditorFactoryString)]
	public sealed class MamlTopicEditorFactory : IVsEditorFactory, IDisposable
	{
		private MamlPackage editorPackage;
		private ServiceProvider vsServiceProvider;

		public MamlTopicEditorFactory(MamlPackage package)
		{
		...
		public int MapLogicalView(ref Guid rguidLogicalView, out string pbstrPhysicalView)
		{
			...
			else if (VSConstants.LOGVIEWID.TextView_guid == rguidLogicalView)
			{
				...
				// In addition our MamlTopicEditorPane implements IVsCodeWindow and we also provide the 
		...
		/// thing. 
		/// NOTE: The priority of our editor is specified in the ProvideEditorExtensionAttribute on the package class.
		/// 
										...
										out int pgrfCDW)
		{
			...
			pguidCmdUI = GuidList.guidDaveSexton_XmlGel_VisualStudioEditorFactory;
			pgrfCDW = 0;
			...
			MamlTopicEditorPane NewEditor = new MamlTopicEditorPane(editorPackage);
